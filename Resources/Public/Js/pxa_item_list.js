    ...
    function () {
        var PxaProjectDetailView = function () {
            ...
            self.init = function () {
                ...
                $('#categories-filter input[type="checkbox"]').on(
                    'change',
                    function () {
            ...
            self.showDetailView = function (elem, animate) {
                var template = $('#preview-template').clone();
                ...
                template.attr('id', 'preview-detail-view');
                ...
                var swiper = new Swiper(
                    template.find('.swiper-container-project-view'),
                    {
                        direction: 'vertical',
                        slidesPerView: 'auto',
                        freeMode: true,
            ...
            self.hideVisible = function (currentVisible, animate) {
                ...
                if (animate) {
                    ...
                    currentVisible.css('height', '0').one(
                        self.transEndEventName,
                        function () {
                            $(this).remove();
                        }
            ...
            self.scrollClick = function (event, element, swiper, mainDescriptionWrapper) {
                ...
                if ((scrollDown && swiper.isEnd) || (!scrollDown && swiper.isBeginning)) {
                    return false;
                }
